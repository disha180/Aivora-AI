...
export default function InstagramScreen() {
  ...
  const loadHistory = async () => {
    try {
      ...
      setHistory(response.data.filter((item: TrendData) => item.platform === 'Instagram'));
    } catch (error) {
    ...
    <View style={styles.container}>
      <ScrollView style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Instagram Trends</Text>
      ...
      >
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Analyze Instagram Trend</Text>
